...
//   Direct SDMMC interface for fast audio streaming
// =========================
//#define SD_CLK          14      // SDMMC Clock
//#define SD_CMD          15      // SDMMC Command
#define SD_CS           2      // SD Card Chip Select (SPI mode)
// CD pin (Card Detect) - optional, can ignore or use GPIO for detection
